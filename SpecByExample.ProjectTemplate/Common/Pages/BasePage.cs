...
namespace $rootname$.Common.Pages
{
    ...
    /// </summary>
    public abstract class Base$rootname$Page : BaseSeleniumPage
    {
        public Base$rootname$Page(IWindsorContainer container, IWebDriver driver, string title, string code)
            : this(container, driver)
        {
            // Nothing to do here
        }

        public Base$rootname$Page(IWindsorContainer container, IWebDriver driver)
