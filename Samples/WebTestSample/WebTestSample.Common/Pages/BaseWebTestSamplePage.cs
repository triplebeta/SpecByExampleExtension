...
namespace WebTestSample.Common.Pages
{
    ...
    /// </summary>
    public abstract class BaseWebTestSamplePage : BaseSeleniumPage
    {
        public BaseWebTestSamplePage(IWindsorContainer container, IWebDriver driver, string title, string code)
            : this(container, driver)
        {
            // Nothing to do here
        }

        public BaseWebTestSamplePage(IWindsorContainer container, IWebDriver driver)
