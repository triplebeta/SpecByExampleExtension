...
{
    [Binding]
    public partial class Test222Steps : BaseSeleniumSteps
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="state">State is passed in using Constructor Injection</param>
        public Test222Steps(SeleniumBrowserInfo state) : base(state) { }


        #region Arrange - Given

        [Given("I go to the Test222 on url '(.*)'")]
