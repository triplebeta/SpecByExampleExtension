...
{
    [Binding]
    public partial class Test6Steps : BaseSeleniumSteps
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="state">State is passed in using Constructor Injection</param>
        public Test6Steps(SeleniumBrowserInfo state) : base(state) { }


        #region Arrange - Given

        [Given("I go to the Test6 on url '(.*)'")]
