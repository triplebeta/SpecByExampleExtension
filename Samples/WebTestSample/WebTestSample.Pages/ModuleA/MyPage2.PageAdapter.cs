...
{
    /// <summary>
    /// Implements the <seealso cref="https://code.google.com/p/selenium/wiki/PageObjects">PageObject</seealso> for MyPage2.
    /// </summary>
	/// <remarks>Generated using the T4 tempate.</remarks>
    public partial class MyPage2 : BaseWebTestSamplePage
    {
        public MyPage2(IWindsorContainer container, IWebDriver driver)
