...
{
    /// <summary>
    /// Implements the <seealso cref="https://code.google.com/p/selenium/wiki/PageObjects">PageObject</seealso> for MyPage1.
    /// </summary>
	/// <remarks>Generated using the T4 tempate.</remarks>
    public partial class MyPage1 : $basepageclass$
    {
        public MyPage1(IWindsorContainer container, IWebDriver driver)
