...
{
    /// <summary>
    /// Baseclass for TestProject1 pages that show a list of items
    /// </summary>
    public abstract class BaseTestProject1ListPage<TTableEnum> : BaseTestProject1Page
    {
        private const int COLUMN_NOT_FOUND = -1;

        public BaseTestProject1ListPage(IWindsorContainer container, IWebDriver driver, string title, string code)
            : this(container, driver)
        {
            // Nothing to do here
        }

        public BaseTestProject1ListPage(IWindsorContainer container, IWebDriver driver)
