...
using TestProject1.Pages.ModuleA;

namespace TestProject1.Pages.ModuleA.Specs
{
    [Binding]
    public partial class MyPage3Steps : BaseSeleniumSteps
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="state">State is passed in using Constructor Injection</param>
        public MyPage3Steps(SeleniumBrowserInfo state) : base(state) { }


        #region Arrange - Given

        [Given("I go to the MyPage3 on url '(.*)'")]
