...
using TestProject4.Pages.ModuleA;

namespace TestProject4.Pages.ModuleA.Specs
{
    [Binding]
    public partial class HomeSteps : BaseSeleniumSteps
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="state">State is passed in using Constructor Injection</param>
        public HomeSteps(SeleniumBrowserInfo state) : base(state) { }


        #region Arrange - Given

        [Given("I go to the Home on url '(.*)'")]
