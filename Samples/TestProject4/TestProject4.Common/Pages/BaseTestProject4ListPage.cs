...
{
    /// <summary>
    /// Baseclass for TestProject4 pages that show a list of items
    /// </summary>
    public abstract class BaseTestProject4ListPage<TTableEnum> : BaseTestProject4Page
    {
        private const int COLUMN_NOT_FOUND = -1;

        public BaseTestProject4ListPage(IWindsorContainer container, IWebDriver driver, string title, string code)
            : this(container, driver)
        {
            // Nothing to do here
        }

        public BaseTestProject4ListPage(IWindsorContainer container, IWebDriver driver)
